...
var WebKitBufferPlayer = function(context, onComplete) {
    Node.call(this, context, 0, 1);
    this.onComplete = onComplete;
    this.isWebKit = this.context.device.sink instanceof Sink.sinks.webkit;
    this.ready = false;
    ...
    this.context = this.context.device.sink._context;
    this.jsNode = null;
    this.source = null;
...
WebKitBufferPlayer.prototype = Object.create(Node.prototype);
WebKitBufferPlayer.prototype.constructor = WebKitBufferPlayer;
...
module.exports = WebKitBufferPlayer;
