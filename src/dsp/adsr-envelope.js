 ...
 */
var ADSREnvelope = function(context, gate, attack, decay, sustain, release,
                            onComplete) {
    var levels = [0, 1, sustain, 0];
    var times = [attack, decay, release];
    Envelope.call(this, context, gate, levels, times, 2, onComplete);
...
ADSREnvelope.prototype = Object.create(Envelope.prototype);
ADSREnvelope.prototype.constructor = ADSREnvelope;
