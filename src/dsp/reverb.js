 ...
 */
var Reverb = function(context, mix, roomSize, damping) {
    ...
    this.mix = new Parameter(this, 1, mix);

    // Room size control
    var roomSize = roomSize || this.initialRoomSize;
    this.roomSize = new Parameter(this, 2, roomSize);
...
Reverb.prototype = Object.create(Node.prototype);
