 ...
 */
var Limiter = function(context, threshold, attack, release) {
    Node.call(this, context, 4, 1);
    this.linkNumberOfOutputChannels(0, 0);

    // Parameters
    this.threshold = new Parameter(this, 1, threshold || 0.95);
    this.attack = new Parameter(this, 2, attack || 0.01);
    this.release = new Parameter(this, 2, release || 0.4);

    this.followers = [];
};
Limiter.prototype = Object.create(Node.prototype);
