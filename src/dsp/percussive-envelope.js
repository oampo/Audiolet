 ...
 */
var PercussiveEnvelope = function(context, gate, attack, release,
                                  onComplete) {
    var levels = [0, 1, 0];
    var times = [attack, release];
    Envelope.call(this, context, gate, levels, times, null, onComplete);

    this.attack = this.times[0];
    this.release = this.times[1];
};
PercussiveEnvelope.prototype = Object.create(Envelope.prototype);
PercussiveEnvelope.prototype.constructor = PercussiveEnvelope;
...
module.exports = PercussiveEnvelope;
