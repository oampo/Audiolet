 ...
 */
var DampedCombFilter = function(context, maximumDelayTime, delayTime,
                                decayTime, damping) {
    ...
    this.damping = new Parameter(this, 3, damping);
    var bufferSize = maximumDelayTime * this.context.device.sampleRate;
    this.buffers = [];
    this.readWriteIndex = 0;
    this.filterStores = [];
};
DampedCombFilter.prototype = Object.create(Node.prototype);
DampedCombFilter.prototype.constructor = DampedCombFilter;
...
module.exports = DampedCombFilter;
