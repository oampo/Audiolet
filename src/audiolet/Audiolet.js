...
var Limiter = new Class({
    Extends: AudioletGroup,

    initialize: function(audiolet, threshold, attack, release) {
...
var LimitFromAmplitude = new Class({
    Extends: AudioletNode,
    initialize: function(audiolet, threshold) {
        AudioletNode.prototype.initialize.apply(this, [audiolet, 3, 1]);
        this.linkNumberOfOutputChannels(0, 0);
