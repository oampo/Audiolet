 ...
 * @depends ../core/AudioletNode.js
 */
var CombFilter=function(a,d,c,b){AudioletNode.call(this,a,3,1);this.linkNumberOfOutputChannels(0,0);this.maximumDelayTime=d;this.delayTime=new AudioletParameter(this,1,c||1);this.decayTime=new AudioletParameter(this,2,b);this.buffers=[];this.readWriteIndex=0};extend(CombFilter,AudioletNode);CombFilter.prototype.generate=function(){var j=this.inputs[0];var c=this.outputs[0];var k=this.audiolet.device.sampleRate;var f=this.delayTime.getValue();var g=this.decayTime.getValue();var a=Math.exp(-3*f/g);var h=j.samples.length;for(var e=0;e<h;e++){if(e>=this.buffers.length){var b=this.maximumDelayTime*k;this.buffers.push(new Float32Array(b))}var d=this.buffers[e];var c=d[this.readWriteIndex];c.samples[e]=c;d[this.readWriteIndex]=j.samples[e]+a*c}this.readWriteIndex+=1;if(this.readWriteIndex>=f){this.readWriteIndex=0}};CombFilter.prototype.toString=function(){return"Comb Filter"};
/*!
 * @depends ../core/AudioletNode.js
 */
