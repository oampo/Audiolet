 ...
 * @depends ../core/AudioletNode.js
 */
var Envelope=function(b,c,d,f,a,e){AudioletNode.call(this,b,1,1);this.gate=new AudioletParameter(this,0,c||1);this.levels=d;this.times=f;this.releaseStage=a;this.onComplete=e;this.stage=null;this.time=null;this.changeTime=null;this.level=0;this.delta=0;this.gateOn=false};extend(Envelope,AudioletNode);Envelope.prototype.generate=function(h,p){var e=p[0];var m=e.getChannelData(0);var n=this.gate;var j,c;if(n.isStatic()){j=n.getValue()}else{c=n.getChannel()}var r=this.releaseStage;var l=this.stage;var d=this.time;var g=this.changeTime;var b=this.level;var q=this.delta;var k=this.gateOn;var o=false;var a=e.length;for(var f=0;f<a;f++){if(c){j=c[f]}if(j&&!k){k=true;l=0;d=0;o=true}if(k&&!j){k=false;if(r){l=r;o=true}}if(g){d+=1;if(d>=g){l+=1;if(l!=r){o=true}else{g=null;q=0}}}if(o){if(l!=this.times.length){q=this.calculateDelta(l,b);g=this.calculateChangeTime(l,d)}else{if(this.onComplete){this.onComplete()}l=null;d=null;g=null;q=0}o=false}b+=q;m[f]=b}this.stage=l;this.time=d;this.changeTime=g;this.level=b;this.delta=q;this.gateOn=k};Envelope.prototype.calculateDelta=function(b,d){var c=this.levels[b+1]-d;var a=this.times[b]*this.audiolet.device.sampleRate;return(c/a)};Envelope.prototype.calculateChangeTime=function(b,c){var a=this.times[b]*this.audiolet.device.sampleRate;return(c+a)};Envelope.prototype.toString=function(){return"Envelope"};
/*!
 * @depends Envelope.js
 */
