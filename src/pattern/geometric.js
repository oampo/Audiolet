 ...
 */
var Geometric = function(start, step, repeats) {
    Pattern.call(this);
    this.start = start;
    this.value = start;
    this.step = step;
...
Geometric.prototype = Object.create(Pattern.prototype);
Geometric.prototype.constructor = Pattern;
 ...
 * Reset the pattern
 */
Geometric.prototype.reset = function() {
