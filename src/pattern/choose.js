 ...
 */
var Choose = function(list, repeats) {
    Pattern.call(this);
    this.list = list;
    this.repeats = repeats || 1;
    this.position = 0;
};
Choose.prototype = Object.create(Pattern.prototype);
Choose.prototype.constructor = Pattern;
 ...
 */
Choose.prototype.next = function() {
    var returnValue;
 ...
 * Reset the pattern
 */
Choose.prototype.reset = function() {
    this.position = 0;
