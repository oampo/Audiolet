 ...
 */
var Arithmetic = function(start, step, repeats) {
    Pattern.call(this);
    this.start = start;
    this.value = start;
    this.step = step;
...
Arithmetic.prototype = Object.create(Pattern.prototype);
Arithmetic.prototype.constructor = Pattern;
 ...
 * Reset the pattern
 */
Arithmetic.prototype.reset = function() {
