/**
 * Class representing a single input of an Node
 *
 * @constructor
 * @param {Node} node The node which the input belongs to.
 * @param {Number} index The index of the input.
 */
var Input = function(node, index) {
    this.node = node;
    this.index = index;
    this.connectedFrom = [];
 ...
 *
 * @param {Output} output The output to connect to.
 */
 ...
 *
 * @param {Output} output The output to disconnect from.
 */
Input.prototype.disconnect = function(output) {
