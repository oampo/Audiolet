 ...
 */
var Buffer = function(numberOfChannels, length) {
 ...
 */
Buffer.prototype.getChannelData = function(channel) {
 ...
 */
Buffer.prototype.setSection = function(buffer, length, inputOffset,
                                               outputOffset) {
 ...
 *
 * @param {Buffer} buffer The buffer to add data from.
 */
Buffer.prototype.add = function(buffer) {
 ...
 * @param {Number} [outputOffset=0] An offset to write data to.
 */
Buffer.prototype.addSection = function(buffer, length, inputOffset,
                                               outputOffset) {
    inputOffset = inputOffset || 0;
    outputOffset = outputOffset || 0;
    var numberOfChannels = buffer.numberOfChannels;
 ...
 */
Buffer.prototype.resize = function(numberOfChannels, length, lazy,
                                           offset) {
    offset = offset || 0;
    // Local variables
 ...
 *
 * @param {Buffer} buffer The buffer to append to this buffer.
 */
 ...
 *
 * @param {Buffer} buffer The buffer to move data into.
 */
Buffer.prototype.pop = function(buffer) {
    var bufferLength = buffer.length;
 ...
 *
 * @param {Buffer} buffer The buffer to prepend to this buffer.
 */
Buffer.prototype.unshift = function(buffer) {
    var bufferLength = buffer.length;
 ...
 * @param {Buffer} buffer The buffer to move data into.
 */
Buffer.prototype.shift = function(buffer) {
    var bufferLength = buffer.length;
 ...
 */
Buffer.prototype.combined = function() {
    var channels = this.channels;
    var numberOfChannels = this.numberOfChannels;
    var length = this.length;
 ...
 */
Buffer.prototype.interleaved = function() {
    var channels = this.channels;
    var numberOfChannels = this.numberOfChannels;
    var length = this.length;
 ...
 *
 * @return {Buffer} The copy of the buffer.
 */
Buffer.prototype.copy = function() {
    var buffer = new Buffer(this.numberOfChannels, this.length);
    buffer.set(this);
    return buffer;
};
 ...
 */
Buffer.prototype.load = function(path, async, callback) {
