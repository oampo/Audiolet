...
/**
 * A container for collections of connected Nodes.  Groups make it
 ...
 */
var Group = function(context, numberOfInputs, numberOfOutputs) {
    this.context = context;

    this.inputs = [];
    for (var i = 0; i < numberOfInputs; i++) {
        this.inputs.push(new PassThroughNode(this.context, 1, 1));
    }

    this.outputs = [];
    for (var i = 0; i < numberOfOutputs; i++) {
        this.outputs.push(new PassThroughNode(this.context, 1, 1));
    }
};
 ...
 */
Group.prototype.connect = function(node, output, input) {
 ...
 */
Group.prototype.disconnect = function(node, output, input) {
