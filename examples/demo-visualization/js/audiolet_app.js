function playExample() {
    var HighSynth = AudioletGroup.extend({
    ...
    var BassSynth = AudioletGroup.extend({
    ...
    var Shaker = AudioletGroup.extend({
    ...
    Demo.prototype.playHighSynth = function() {
        ...
        this.audiolet.scheduler.play([degreePattern],
            ...
            function(degree) {
                // Set the gate
                this.highSynth.trigger.set('trigger', 1);
                // Calculate the frequency from the scale
                var frequency = this.scale.getFrequency(degree,
                                                        this.c2Frequency,
                                                        3);
                // Set the frequency
                this.highSynth.triangle.set('frequency', frequency);
            }.bind(this)
        );
    }
    ...
    Demo.prototype.playMidSynth = function() {
        ...
        this.audiolet.scheduler.play([degreePattern],
            ...
            function(degree) {
                // Set the gate
                this.midSynth.trigger.set('trigger', 1);
                // Calculate the frequency from the scale
                var frequency = this.scale.getFrequency(degree,
                                                        this.c2Frequency,
                                                        1);
                // Set the frequency
                this.midSynth.triangle.set('frequency', frequency);
            }.bind(this)
        );
    }
    ...
    Demo.prototype.playBassSynth = function() {
        ...
        this.audiolet.scheduler.play(patterns, durationPattern,
            function(degree, gate) {
                // Set the gates
                this.bassSynth.gainEnv.set('gate', gate);
                this.bassSynth.fmEnv.set('gate', gate);
                // Calculate the frequency from the scale
                var frequency = this.scale.getFrequency(degree,
                                                        this.c2Frequency,
                                                        1);
                // Set the frequency
                this.bassSynth.frequencyMulAdd.set('add', frequency);
                this.bassSynth.frequencyModulator.set('frequency', frequency * 4);
            }.bind(this)
        );
    }
